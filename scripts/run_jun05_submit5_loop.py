...
CANDIDATES = [
    {
        ...
        "file": "submission.zip",
        "message": "jun05_cycle01_debatreya_best086_under5min",
        "reason": "Fresh 2026-06-04 Code run with submission.zip and title-claimed 0.86; low runtime makes it a clean public-output probe.",
    },
    {
        "cycle": 2,
        ...
        "file": "submission.zip",
        "message": "jun05_cycle02_mirza_best_notebook_086_probe",
        "reason": "Fresh 2026-06-04 Mirza 0.86 slug with submission.zip; distinct from the 2026-06-04 submitted Mirza anchor.",
    },
    {
        "cycle": 3,
        ...
        "file": "submission.zip",
        "message": "jun05_cycle03_mirza_model_notebook_probe",
        "reason": "Fresh 2026-06-04 Mirza model notebook output with submission.zip; likely stable 0.86 family but still untested locally.",
    },
    {
        "cycle": 4,
        "ref": "adilshamim8/nvidia-nemotron-model-reasoning-challenge-101",
        "version": 4,
        "scriptVersionId": 311680542,
        "file": "submission.zip",
        "message": "jun05_cycle04_adil_reasoning_101",
        "reason": "GPU COMPLETE output with adapter files and submission.zip; not locally submitted yet, so it is a controlled exploration slot.",
    },
    {
        "cycle": 5,
        ...
        "file": "submission.zip",
        "message": "jun05_cycle05_daniel_finding_nemo_probe",
        "reason": "New 2026-06-04 finding-nemo fork with adapter files and submission.zip; probes whether fork drift beats the known 0.86 output.",
    },
    {
        "cycle": 6,
        ...
        "file": "submission.zip",
        "message": "jun05_cycle06_kuang_087_training_fallback",
        "reason": "Title claims 0.87 and latest output has submission.zip, but 2026-06-01 scan marked the same family low-score; fallback/high-variance only.",
    },
    {
        "cycle": 7,
        ...
        "file": "submission.zip",
        "message": "jun05_cycle07_ayomide_finding_nemo_anchor",
        "reason": "Known stable public Code output; reproduced at 0.86 on 2026-06-04.",
    },
    {
        "cycle": 8,
        ...
        "file": "submission.zip",
        "message": "jun05_cycle08_afr1ste_tinker_adapter_anchor",
        "reason": "Known 0.86-capable fallback; reproduced at 0.86 on 2026-06-04.",
    },
    {
        "cycle": 9,
        "ref": "siao112/nemotron-kienngx-fork",
        "version": 18,
        "scriptVersionId": 324343289,
        "file": "submission.zip",
        "message": "jun05_cycle09_siao_kienngx_latest_fallback",
        "reason": "Valid latest submission.zip but scored 0.85 on 2026-06-04, so it is fallback only.",
    },
    {
        "cycle": 10,
        "ref": "habanwer/nemotron-atlas",
        "version": 58,
        "scriptVersionId": 323572693,
        "file": "submission.zip",
        "message": "jun05_cycle10_habanwer_atlas_fallback",
        "reason": "Has submission.zip but older scans treated this family as weak/high-risk; use only if safer candidates fail.",
    },
    {
        "cycle": 11,
        "ref": "rohanrk1813/nvidia-comp",
        "file": "submission.zip",
        "message": "jun05_cycle11_rohan_nvidia_comp_fallback",
        "reason": "High-visibility fallback with historical valid zip; no stronger signal than main queue.",
    },
]
...
def submissions_snapshot():
    def query():
        rows = []
        for s in kaggle.api.competition_submissions(COMP)[:60]:
    ...
    try:
        kernels = with_alarm(
            ...
            lambda: kaggle.api.kernels_list(
                competition=COMP, page=1, page_size=15, sort_by="dateRun"
            )
            or [],
        )
        for k in kernels[:15]:
